...
export const CreateBalanceAdjustmentRequest = zod
  .strictObject({
    accountId: zod.uuid(),
...
export type CreateBalanceAdjustmentRequest = zod.input<
  typeof CreateBalanceAdjustmentRequest
>;
export type CreateBalanceAdjustmentRequestOutput = zod.output<
  typeof CreateBalanceAdjustmentRequest
>;
