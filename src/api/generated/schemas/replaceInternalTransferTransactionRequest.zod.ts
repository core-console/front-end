...
export const ReplaceInternalTransferTransactionRequest = zod
  .strictObject({
    amount: zod
      .strictObject({
        amount: zod
...
export type ReplaceInternalTransferTransactionRequest = zod.input<
  typeof ReplaceInternalTransferTransactionRequest
>;
export type ReplaceInternalTransferTransactionRequestOutput = zod.output<
  typeof ReplaceInternalTransferTransactionRequest
>;
