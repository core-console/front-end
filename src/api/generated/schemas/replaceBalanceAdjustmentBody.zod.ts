...
export const ReplaceBalanceAdjustmentBody = zod
  .strictObject({
    accountId: zod.uuid(),
...
export type ReplaceBalanceAdjustmentBody = zod.input<
  typeof ReplaceBalanceAdjustmentBody
>;
export type ReplaceBalanceAdjustmentBodyOutput = zod.output<
  typeof ReplaceBalanceAdjustmentBody
>;
